...
def ui_adauga_cheltuiala(lista, undo_list):
    try:
...
def ui_sterge_cheltuiala(lista, undo_list):
    try:
...
def ui_modifica_cheltuiala(lista, undo_list):
    try:
...
def ui_adaugare_valoare_by_data(lista, undo_list):
    try:
...
def ui_sterge_cheltuiala_by_numar(lista, undo_list):
    try:
        numar = int(input("Introduceti numarul apartamentului: "))
...
def run_ui(lista):
    ...
    while True:
        ...
        if optiune == "1":
            lista = ui_adauga_cheltuiala(lista, undo_list)
        elif optiune == "2":
            lista = ui_sterge_cheltuiala(lista, undo_list)
        elif optiune == "3":
            lista = ui_modifica_cheltuiala(lista, undo_list)
        elif optiune == "4":
            lista = ui_adaugare_valoare_by_data(lista, undo_list)
        elif optiune == "5":
            ui_suma_maxima_by_tip(lista)
        elif optiune == "6":
            lista = ui_sterge_cheltuiala_by_numar(lista, undo_list)
        elif optiune == "7":
